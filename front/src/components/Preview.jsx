        ...
        <div className='w-screen h-screen flex justify-center flex-row items-center bg-indigo-50'>
            ...
            <div className="flex flex-col max-w-xs font-sans ml-11 ">
                ...
                <form
                    ...
                    <select className="block appearance-none mt-9 w-4/5 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
