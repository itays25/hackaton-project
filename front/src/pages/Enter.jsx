...
const Enter = () => {
    ...
    return (
        <div className="relative isolate overflow-hidden flex lg:flex-row bg-indigo-50 w-full h-screen py-16 sm:py-24 flex-col " >
         ...
         <div className='ml-6 max-w-xs'>
            ...
            <div className='w-auto flex justify-end '>   <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
          ...
          DONOR
            ...
            <p className='mt-6 mb-6'>type her tjoasjdjs sd j kjads hdsa jkadsh adskjdsa type her tjoasjdjs sd j kjads hdsa jkadsh adskjdsa adh dskjsdahjds akjsda sdhjsd kjadshdsjsdah</p>
           <div className='w-auto flex justify-end  '> <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full flex justify-end">
