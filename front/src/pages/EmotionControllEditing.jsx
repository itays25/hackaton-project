...
export default function Statistics() {
    ...
    //     {
    //     defaultValues: () => {
    //         const all = async () => await axios.get('http://localhost:8639/emotion/allEmotions');
    //         all[index]?.spectrum
                ...
                <div className="h-auto">
                    <div key={index} className="p-3 h-auto ">
                        ...
                        <div className="flex justify-between border-4 w-52 ml-2 text-2xl rounded ">
                            ...
                            {/* <input type="text" {...register("spectrumName")} />
                            {register("hidden", { value: `${emotionList[index]?.spectrum
                                    .charAt(0).toUpperCase() + emotionList[index]?.spectrum.slice(1)}` })} */}
